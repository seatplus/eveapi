...
it('writes labels to database on normal execution', function () {
    $label = (object) ['label_id' => 2001, 'label_name' => 'Test Label'];
...
it('handles multiple pages and writes all labels', function () {
    $label1 = (object) ['label_id' => 2001, 'label_name' => 'Page One Label'];
    $label2 = (object) ['label_id' => 2002, 'label_name' => 'Page Two Label'];
